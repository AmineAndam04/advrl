...
def get_config():
    config = ConfigDict()
    config.name = "cpo_radial_ppo"  # config id
    # Neural nets
    ...
    config.ki = 0.0001
    config.kd = 0.0
    config.reg_coef = -1.0  # SA-Reg loss coefficient. If <0 it will be learned
    ...
    config.verbose = 0
    config.algo_name = "cpo_radial"
    config.prefix_run_name = "CPO-Radial-PPO"
    # Evaluation
