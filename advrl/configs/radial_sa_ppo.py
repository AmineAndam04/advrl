...
def get_config():
    config = ConfigDict()
    config.name = "radial_sa_ppo"  # config id
    # Neural nets
    ...
    config.radial_coef = 0.01  # Radial loss coefficient
    config.reg_coef = 0.01  # SA-Reg loss coefficient
    ...
    config.verbose = 0
    config.algo_name = "radial_sa"
    config.prefix_run_name = "Radial-SA-PPO"
    # Evaluation
